...
template <class T> struct pptr_t { T** pptr=nullptr; pptr_t()=default; pptr_t( T*& ptr ):pptr(&ptr){} pptr_t( const T*& ptr ):pptr(&const_cast<T*&>(ptr)){} pptr_t( T** _pptr ):pptr(_pptr){} pptr_t( const T** _pptr ):pptr((T**)_pptr){} pptr_t& operator=( T*& ptr ){ pptr=&ptr; return *this; } pptr_t& operator=( const T*& ptr ){ pptr=&const_cast<T*&>(ptr); return *this; } pptr_t& operator=( T** _pptr ){ pptr=_pptr; return *this; } pptr_t& operator=( const T** _pptr ){ pptr=(T**)_pptr; return *this; } T* operator->(){ return pptr?*pptr:nullptr; } const T* operator->() const { return pptr?*pptr:nullptr; } operator T*(){ return pptr?*pptr:nullptr; } operator const T*() const { return pptr?*pptr:nullptr; } };
